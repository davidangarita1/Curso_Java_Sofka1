...
public class MeRefApp {
    ...
    public void referenciasMetodoInstanciaObjetoArbitrario() {
        String[] nombres = {"Mito", "Code", "Jaime", "Alejandro", "Zapata", "Brayan"};
    ...
    public void referenciarConstructor() {
        ...
        */
        ...
        Persona per = iper3.crear(1, "DangWebs");
        System.out.println(per.getId()+" - "+per.getNombre());
    }
    ...
    public static void main(String[] args) {
        ...
        // app.operar();
        // app.referenciasMetodoInstanciaObjetoArbitrario();
